...
export const ALL_13_SERVICES_DETAILED: ServiceDetail[] = [
  {
    ...
    tagline:
      "1.2 saniyede açılan, mobil kusursuz ve doğrudan sıcak müşteri aratan modern satış siteleri.",
    heroDesc:
      "Yavaş açılan hazır temaları ve boşa harcanan bütçeleri unutun. Next.js ve Cloudflare altyapısıyla sıfırdan kodlanan, Google Haritalar ile entegre ve her ziyaretçiyi doğrudan telefon aramasına dönüştüren kapalı devre web motorları inşa ediyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 01 Web Tasarım & Yazılım Görseli]
    image:
  ...
  },
  {
    ...
    category: "DİJİTAL VARLIK & REKLAM",
    tagline:
      "Bölgenizdeki her aramada Google Haritalar'da 1. sıraya oturun, müşteriler doğrudan sizi arasın.",
    heroDesc:
      "Yerel işletmeler için en yüksek dönüşüm oranı Google Haritalar'dan gelir. Bölgenizde hizmetinizi arayan müşterilerin rakip dükkanlara değil, doğrudan size ulaşmasını sağlayan 3'lü yerel paket (Local Pack) optimizasyonu yapıyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 02 Google Harita & Yerel SEO Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Sosyal medyada var olmak sadece resim paylaşmak değildir. Potansiyel müşterilerinizin güvenini kazanan, profilinizi ziyaret edeni anında müşteriye çeviren ve algoritmayı lehinize çalıştıran bir vitrin kuruyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 03 Sosyal Medya Yönetimi Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "İlk izlenim saniyeler içinde oluşur. İşletmenizi rakiplerinizden ayıran, kurumsal gücünüzü hissettiren ve müşterinizin zihninde silinmez iz bırakan bir marka kimliği tasarlıyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 04 Grafik Tasarım & Kurumsal Kimlik Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Instagram ve Facebook'ta 'gönderiyi öne çıkar' butonuyla para yakmaktan vazgeçin. Satın alma potansiyeli en yüksek kitleyi hedefleyen, yüksek ROAS sağlayan ve telefonu susmayan kapalı devre reklam kampanyaları yönetiyoruz.",
    deliverables: [
    ...
    badge: "Yüksek Satış",
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 05 Meta Reklam Yönetimi Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "İhtiyacı olan kişi Google'da arama yaptığı an karşısına çıkmak, dijitaldeki en sıcak satış fırsatıdır. Negatif anahtar kelimelerle korunan ve her tıklamayı doğrudan telefon aramasına bağlayan Google Ads kampanyaları kurguluyoruz.",
    deliverables: [
    ...
    badge: "Sıcak Satış",
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 06 Google Ads Reklamları Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Günümüzde en hızlı müşteri kazandıran format dikey videodur. İşletmenizi modern gösteren, güven aşılayan ve izleyeni anında harekete geçiren 4K Reels ve yapay zeka destekli video serileri üretiyoruz.",
    deliverables: [
    ...
    badge: "Viral Etki",
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 07 Video & Reels AI Prodüksiyon Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Tasarım gözü çeker, kelimeler ise satış yaptırır. Ziyaretçilerinizin zihnindeki şüpheleri yok eden, güven inşa eden ve doğrudan harekete geçiren yüksek dönüşümlü satış metinleri yazıyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 08 İçerik Yazarlığı & Satış Metni Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Reklamlar para harcadıkça çalışır, SEO ise kalıcı bir servettir. Google'ın ilk sayfasında doğal olarak üst sıralara yerleşerek her gün ücretsiz ve kaliteli müşteri kazanmanızı sağlıyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 09 SEO & Organik Görünürlük Görseli]
    image:
      "https://images.unsplash.com/photo-1572021335469-31706a17aaef?w=1200&auto=format&fit=crop&q=80",
  },
  {
    ...
    heroDesc:
      "Ürünlerinizi sadece dükkanda değil, tüm Türkiye'ye satmak için hızlı, güvenli ve sepet terk etme oranını minimuma indiren modern e-ticaret altyapıları kuruyoruz.",
    deliverables: [
    ...
    badge: "Online Mağaza",
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 10 E-Ticaret Satış Sistemleri Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Reklamla müşteri getirmek işin yarısıdır; asıl para satışın hızlı kapatılmasında kazanılır. Gelen her talebi 3 saniyede karşılayan, temsilcinizin telefonuna bildiren ve takip eden otomasyonlar kuruyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 11 CRM & WhatsApp Takip Görseli]
    image:
  ...
  },
  {
    ...
    heroDesc:
      "Karanlıkta kurşun sıkmayın. Bölgenizdeki ve sektörünüzdeki rakiplerin hangi kelimelerden para kazandığını, ne kadar reklam harcadığını ve zayıf yönlerini analiz ederek pazar payını elinizden almalarını engelliyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 12 Rakip & Pazar Analizi Görseli]
    image:
      "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=1200&auto=format&fit=crop&q=80",
  },
  {
    ...
    heroDesc:
      "Biz bir kez iş yapıp kaybolanlardan değiliz. Sloganımızda dediğimiz gibi: 'Sadece ajans değil, büyüme ortağınız.' Her ay yapılan harcamaların ve gelen ciroların hesabını veriyor, birlikte büyüyoruz.",
    deliverables: [
    ...
    // TODO_CONTENT: [CEO Görseli Bekleniyor - Hizmet 13 Aylık Büyüme Danışmanlığı Görseli]
    image:
      "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&auto=format&fit=crop&q=80",
  },
];
