...
export const REAL_CLIENT_REFERENCES: ClientReference[] = [
  {
    ...
    logo: "/clients/aybar-nakliyat.png",
  ...
  {
    id: "gaziantep-asansorlu",
    name: "Gaziantep Asansörlü Taşımacılık",
    city: "Gaziantep",
    industryLabel: "Güneydoğu Bölge Filosu",
    url: "https://www.gaziantepasansorlutasimacilik.com.tr/",
    logo: "/clients/gaziantep-asansorlu.png",
    category: "Şehitkamil & Şahinbey Taşıma",
    badge: "Bölge Lideri",
    summary:
      "Gaziantep genelinde ve Güneydoğu Anadolu bölgesinde ağır yük ve ev eşyası taşımacılığında profesyonel asansör kiralama ve lojistik.",
    metrics: {
      speed: "1.0 sn",
      calls: "+%95 Çağrı",
      seoRank: "Gaziantep 1. Sıra",
    },
    whatWeDid: [
      "Yüksek dönüşüm oranlı mobil öncelikli hızlı teklif formu tasarlandı.",
      "Şahinbey ve Şehitkamil ilçelerine özel hedefli arama ağı reklamları yapılandırıldı.",
      "Gaziantep bölgesinde sektörün en hızlı açılan web altyapısı devreye alındı.",
    ],
  },
];
