      ...
      <div className="max-w-[1440px] mx-auto relative flex flex-col lg:flex-row gap-4 sm:gap-6 items-stretch">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center py-7 px-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-[0_15px_35px_rgba(0,0,0,0.5)] shrink-0 self-center gap-5 z-20">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-9 h-9 rounded-full flex items-center justify-center text-neutral-300 hover:text-[#0A0A0A] hover:bg-[#FFC300] hover:shadow-[0_0_20px_#FFC300] hover:border-[#FFC300] transition-all duration-300"
            aria-label="LinkedIn"
            title="LinkedIn"
          >
        ...
        {/* ========================================================= */}
        {/* ANA KOYU KART (EN ESKİ HALİ, 4 KOLON, TÜRKÇELEŞTİRİLMİŞ)     */}
        {/* ========================================================= */}
        <div className="flex-1 bg-[#111111] text-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 md:p-12 lg:p-14 relative overflow-hidden shadow-2xl border border-neutral-800">
          ...
          <div className="lg:hidden flex items-center gap-3 bg-white/10 backdrop-blur-xl px-4 py-2 rounded-full border border-white/20 text-neutral-300 mb-6 w-fit">
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-[#FFC300] transition-colors"><Linkedin className="w-4 h-4" /></a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-[#FFC300] transition-colors"><Twitter className="w-4 h-4" /></a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-[#FFC300] transition-colors"><Instagram className="w-4 h-4" /></a>
            <a href="https://growbdijital.com" target="_blank" rel="noreferrer" className="hover:text-[#FFC300] transition-colors"><Globe className="w-4 h-4" /></a>
          </div>

          {/* Üst Kısım: Canlı Durum Rozeti & SAĞ ÜST ESPİRİLİ YUKARI ÇIK BUTONU */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8 mb-10 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col items-start space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                <a
                  href="https://wa.me/905414842426?text=Merhaba%20GrowB%20Dijital%2C%20bilgi%20almak%20istiyorum."
                  target="_blank"
                  rel="noreferrer"
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] text-neutral-400 font-medium mt-0.5">
                    5.0 / 5.0 • 69 Doğrulanmış Müşteri Yorumu
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 flex flex-col">
              ...
              <ul className="flex flex-col space-y-3 text-sm font-medium text-neutral-300">
                ...
                <li><a href="#yorumlar" className="hover:text-[#FFC300] transition-colors">Müşteri Yorumları</a></li>
              ...
              <div className="flex flex-col space-y-3 text-sm text-neutral-300">
                <div className="p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 space-y-2">
                  <div className="flex items-center gap-2 text-white font-bold text-sm">
                    ...
                    <span>Nevşehir / Kapadokya Bölgesi</span>
                  </div>
                  <p className="text-neutral-400 text-xs leading-relaxed">
                    Merkez / Nevşehir — 50100 Türkiye
                  </p>
                </div>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-bold text-white group-hover:text-[#FFC300] transition-colors">0541 484 24 26</span>
                    </div>
                  </div>
                ...
                <a 
                  href="mailto:info@growbdijital.com" 
                  className="p-3 rounded-2xl bg-white/[0.04] hover:bg-[#FFC300]/10 border border-white/10 hover:border-[#FFC300]/40 transition-all flex items-center justify-between group"
                >
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-[#FFC300]/10 flex items-center justify-center text-[#FFC300]">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-bold text-white group-hover:text-[#FFC300] transition-colors">info@growbdijital.com</span>
                    </div>
                  </div>
                  <ArrowUpRight className="w-3.5 h-3.5 text-neutral-500 group-hover:text-[#FFC300] transition-colors" />
                </a>
          ...
          {/* ========================================================= */}
          {/* DEKORATİF BANT: 4 TEMEL BÜYÜME TAAHHÜDÜ (BOŞLUĞU DOLDURUR)  */}
          {/* ========================================================= */}
          ...
          {/* ========================================================= */}
          {/* ALT TELİF HAKKI & LİNKLER (TİCARİ SİCİL NO KALDIRILDI)    */}
          {/* ========================================================= */}
          <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-neutral-500 font-sans">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span>© GrowB Dijital Ltd 2026</span>
