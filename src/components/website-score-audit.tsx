...
import { Gauge, ArrowUpRight, RefreshCw, ShieldCheck, Activity } from "lucide-react";
...
import { WebsiteAuditInputs } from "./audit/website-audit-inputs";
...
export const WebsiteScoreAudit: React.FC = () => {
  ...
  const handleScan = async (e: React.FormEvent) => {
    ...
    if (phone && !kvkkConsent) {
      setErrorInfo(
        "Telefon numaranız ile iletişime geçebilmemiz için lütfen KVKK Aydınlatma Metni'ni onaylayınız."
      );
      return;
    }
