    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="group fixed bottom-6 right-6 z-50 flex select-none items-center gap-3.5 rounded-full border border-neutral-200 bg-white p-2 pl-3 pr-2 text-neutral-950 shadow-[0_20px_50px_rgba(0,0,0,0.4)] transition-all hover:shadow-[0_25px_60px_rgba(0,0,0,0.5)]"
        >
