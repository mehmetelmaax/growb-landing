...
| **02** | `public/works/team/founder-mehmet-demir.webp`                  | `src/components/floating-contact-pill.tsx:33`                       | 200 × 200  | 25 KB      | Sağ alttaki yüzen iletişim hapında yer alan online durum rozetli kurucu vesikalık/portre görseli. |
...
3. `src/components/floating-contact-pill.tsx` satır 33 `/works/team/founder-mehmet-demir.webp` ile güncellenecektir.
